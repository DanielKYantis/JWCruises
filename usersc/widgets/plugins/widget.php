<?php if (hasPerm(2)) { ?>
  <div class="card dash-card" data-id="<?=$widgetName?>" id="<?=$widgetName?>-card">
    <div class="card-header" id="<?=$widgetName?>-card-header">
      ...
      <span class="card-title-text">Plugins | <?=$widgetName?></span><span class="float-end"><a href="?view=plugins">Manage Plugins</a><i class="fa-solid fa-grip ps-2 grippy"></i></span>
    </div>
