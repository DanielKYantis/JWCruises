						...
						<div class="container">
								<div class="row">
									<div class="col-sm-12 py-2">
										<h4>About</h4>
										<p>This widget for check system health!</p>
									</div>
								</div>
						</div>
					</div>
					<div class="navbar-dark shadow-sm py-2">
							...
							<div class="container">
									<div class="row py-3">
										...
										<div class="col-md-4 text-center">
											...
											echo "Total disk usage : ".round($disktotal / 1000000)." MB<br>";
										...
										<div class="col-md-4 text-center">
											...
											settype($uptime, "double");
											$uptime = floor($uptime / 86400);
											echo "Server uptime : ".$uptime." days";
															?>
														</span>
													</div>
												</div>
