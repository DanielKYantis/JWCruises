...
if (!isset($_REQUEST["error"])) { header('Location: home.php'); exit; };
        ...
        <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
          <div class="error-content">
            ...
            <p class="error-description" data-aos="fade-up" data-aos-delay="700">
              The page you are looking for might have been removed, moved, had its name changed, or is temporarily unavailable.
            </p>
            ...
            <div class="error-suggestions" data-aos="fade-up" data-aos-delay="900">
              ...
              <ul>
                <li><a href="/sitemap.xml"><i class="bi bi-arrow-right-circle"></i> Check our sitemap</a></li>
