    ...
    <div class="container">
      ...
      <div class="privacy-header">
        <div class="header-content">
          <div class="last-updated">Last Updated: May 20, 2025</div>
      ...
      <div class="privacy-content">
        ...
        <div class="content-section">
          ...
          <p>We collect information to provide better services to our users. Somoe of the types of information we collect can include:</p>

          <h3>2.1 Information You Provide</h3>
          <p>When you create an account or use our services, you provide us with some personal information that can include:</p>
          <ul>
